...
<head>
    ...
    <title>Creative Link - Bank Assistance</title>
                    ...
                    <div class="service-block-three">
                        <div class="inner-box">
                            ...
                            <div class="lower-content">
                                <h3><a href="company-account.php">Company Account</a></h3>
                                <p>Acepteur sintas haecat sed non dui proident sunt culpa ipsum ...</p>
                                <div class="link"><a href="company-account.php"><i class="fas fa-arrow-right"></i><span>Read More</span></a></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                    <div class="service-block-three">
                        <div class="inner-box">
                            ...
                            <div class="lower-content">
                                <h3><a href="personal-account.php">Personal Account</a></h3>
                                <p>Acepteur sintas haecat sed non dui proident sunt culpa ipsum ...</p>
                                <div class="link"><a href="personal-account.php"><i class="fas fa-arrow-right"></i><span>Read More</span></a></div>
                            </div>
                        </div>
                    </div>
                </div>
