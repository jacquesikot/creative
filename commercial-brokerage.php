...
<title>Creative Link Services - Commercial Brokerage</title>
    ...
    <section class="service-details">
        <div class="auto-container">
            <div class="row clearfix">
                <div class="col-lg-8 col-md-12 col-sm-12 content-side">
                    <div class="service-details-content">
                        <div class="content-style-one">
                            <figure class="image-box"><img src="assets/images/service/commercial_brokerage_dubai.jpg" alt=""></figure>
				...
				<li><a href="commercial-brokerage.php" class="active">Commercial Brokerage</a></li>
