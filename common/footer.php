<footer class="main-footer">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 footer-column">
                            <div class="footer-widget newsletter-widget">
                                ...
                                <div class="widget-content">
                                    <div class="text">
                                        <p>Join our newsletter to receive latest updates & market trends.</p>
                                    </div>
        ...
        <div class="footer-bottom">
            <div class="auto-container">
                <div class="copyright"><p>&copy; 2021 Creative Link - All rights reserved.</p></div>
                <!--<div class="powered"><p>&copy; 2021 Creative Link - All rights reserved.</p></div>-->
                        </div>
        </div>
    </footer>
