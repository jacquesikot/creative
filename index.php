...
<head>
    ...
    <title>Creative Link Services</title>
...
<body class="boxed_wrapper">
            ...
            <div class="slide-item">
                ...
                <div class="auto-container">
                    <div class="content-box">
                        ...
                        <div class="btn-box">
                            <a href="index.php" class="theme-btn style-one">How Can We Help</a>
                ...
                <div class="auto-container">
                    <div class="content-box centred">
                        <ul class="list-item clearfix">
                            ...
                            <li><a href="index.php">Specialized</a>&nbsp;.&nbsp;</li>
                            <li><a href="index.php">Professional</a>&nbsp;.&nbsp;</li>
                        </ul>
                        <h1>International Network To <br />Provide Assistance</h1>
                        <div class="btn-box">
                            <a href="index.php" class="theme-btn style-one mar-0">How Can We Help</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="slide-item">
                ...
                <div class="auto-container">
                    <div class="content-box">
                        ...
                        <div class="btn-box">
                            <a href="index.php" class="theme-btn style-one mr-10">How Can We Help</a>
                            <a href="index.php" class="banner-btn-two">Find a Consultant</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-5 col-md-12 col-sm-12 text-column">
                    <div class="text">
                        ...
                        <a href="aboutus.php"><i class="fas fa-arrow-right"></i><span>Who We Are</span></a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="feature-block-one wow fadeInUp animated animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            ...
                            <div class="lower-content">
                                <div class="inner">
                                    <h3>Offshore License</h3>
                                    <a href="offshore-license.php"><span>Read more</span><i class="fas fa-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 feature-block">
                    <div class="feature-block-one wow fadeInUp animated animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            ...
                            <div class="lower-content">
                                <div class="inner">
                                    <h3>Freezone License</h3>
                                    <a href="freezone-license.php"><span>Read more</span><i class="fas fa-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 feature-block">
                    <div class="feature-block-one wow fadeInUp animated animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            ...
                            <div class="lower-content">
                                <div class="inner">
                                    <h3>Mainland License</h3>
                                    <a href="mainland-license.php"><span>Read more</span><i class="fas fa-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="content-box">
                            ...
                            <div class="inner-box">
                                <div class="single-item">
                                    ...
                                    <h4><a href="index.php">Support On Raising Funds</a></h4>
                                ...
                                <div class="single-item">
                                    ...
                                    <h4><a href="index.php">Outsourced Consulting Business</a></h4>
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                        <div class="service-block-one wow fadeInUp animated animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <h4><a href="#">Financial Advices</a></h4>
                                <div class="inner">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                        <div class="service-block-one wow fadeInUp animated animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <h4><a href="#">Business Tax Reforms</a></h4>
                                <div class="inner">
            ...
            <div class="project-carousel theme-carousel owl-theme owl-carousel owl-dots-none owl-nav-none">
                <div class="project-block-one">
                    <div class="inner-box">
                        ...
                        <div class="lower-content">
                            <p>Lorem Ipsum</p>
                            <h2><a href="bank-assistance.php">Bank Assistance</a></h2>
                        </div>
                    </div>
                </div>
                <div class="project-block-one">
                    <div class="inner-box">
                        ...
                        <div class="lower-content">
                            <p>Lorem Ipsum</p>
                            <h2><a href="company-branding.php">Company Branding</a></h2>
                        </div>
                    </div>
                </div>
                <div class="project-block-one">
                    <div class="inner-box">
                        <figure class="image-box"><img src="assets/images/pro_services_dubai.jpg" alt=""></figure>
                        <div class="lower-content">
                            <p>Lorem Ipsum</p>
                            <h2><a href="pro-services.php">PRO Services</a></h2>
                        </div>
                    </div>
                </div>
                <div class="project-block-one">
                    <div class="inner-box">
                        <figure class="image-box"><img src="assets/images/approvals_in_dubai.jpg" alt=""></figure>
                        <div class="lower-content">
                            <p>Lorem Ipsum</p>
                            <h2><a href="approvals.php">Approvals</a></h2>
                        </div>
                    </div>
                </div>
                <div class="project-block-one">
                    <div class="inner-box">
                        <figure class="image-box"><img src="assets/images/property_management_dubai.jpg" alt=""></figure>
                        <div class="lower-content">
                            <p>Lorem Ipsum</p>
                            <h2><a href="others.php">Others</a></h2>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div id="content_block_two">
                        <div class="content-box">
                            ...
                            <div class="inner-box clearfix">
                                ...
                                <div class="single-progress-box">
                                    <div class="box">
                                        <div class="piechart" data-fg-color="#00ABC7" data-value=".25">
                                            <span>.25</span>
                                        </div>
                ...
                <div class="row clearfix">
                    <div class="col-lg-7 col-md-12 col-sm-12 inner-column">
                        <div class="inner-box">
                            ...
                            <div style="display: none" class="alert alert-success quote-success" role="alert">
                            </div>
                            <div style="display: none" class="alert alert-danger quote-error" role="alert"></div>
                            <form method="post" id="sendrequestform" class="submit-form ">
                                ...
                                <div class="form-group">
                                    <input type="text" name="email" placeholder="Email address *" class="validEmail" validate="Enter email">
                                </div>
                                <div class="form-group">
                                    <input type="text" name="phone" placeholder="Phone *" validate="Enter phone number">
                                </div>
                                <div class="form-group">
                                    <textarea name="message" placeholder="Message"></textarea>
                                </div>
                                <div class="form-group message-btn">
                                    <button type="button" id="sendrequest" class="theme-btn style-one">send request</button>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                    <div class="news-block-one wow fadeInUp animated animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            ...
                            <div class="lower-content">
                                <ul class="post-info">
                                    <li>By <a href="index.php">Admin</a></li>
                                ...
                                <h3><a href="blog-details.php">Take Action For Benefits Of Your Business</a></h3>
                                ...
                                <div class="link"><a href="blog-details.php"><i class="fas fa-arrow-right"></i><span>Read More</span></a></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="news-block-one wow fadeInUp animated animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            ...
                            <div class="lower-content">
                                ...
                                <h3><a href="blog-details.php">Improve Your Investment Through Money</a></h3>
                                <p>Exea conse quat duis irurey dolor sed reprehen derit volupta velit cilum lorem incididunt labore sed magna exceptur aliqua.</p>
                                <div class="link"><a href="blog-details.php"><i class="fas fa-arrow-right"></i><span>Read More</span></a></div>
                            </div>
                        </div>
                    ...
                    <div class="news-block-one wow fadeInUp animated animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            ...
                            <div class="lower-content">
                                ...
                                <h3><a href="blog-details.php">Isolate & Reframe Beliefs For The Future</a></h3>
                                <p>Exea conse quat duis irurey dolor sed reprehen derit volupta velit cilum lorem incididunt labore sed magna exceptur aliqua.</p>
                                <div class="link"><a href="blog-details.php"><i class="fas fa-arrow-right"></i><span>Read More</span></a></div>
                            </div>
                        </div>
        ...
        <div class="auto-container">
            <div class="inner-container clearfix">
                ...
                <div class="btn-box pull-right">
                    <a href="testPdf.pdf" download>DOWNLOAD BROCHURE</a>
                </div>
            </div>
        </div>
    </section>
    ...
    $(document).on('click','form#newsletter',function(){  
    //return formValidate($(this));
        formValidate1($(this),function(res){
            //console.log('tttttt');
            console.log(res);
            if(res){
                alert("tt");
                var formss=$('form#newsletter');
                ...
                $.ajax({
                    ...
                    url: 'http://localhost/ram/creativelink/newslettermail.php',
                    dataType: 'json',
