                                ...
                                <div class="pricing-block-one">
                                    <div class="pricing-table">
                                        ...
                                        <div class="table-content">
                                            <ul class="clearfix"> 
                                                <li>Business Setup with Expert Consultant</li>
                                                <li>Economy Department License Fees</li>
                                                <li>UAE Service - Sponsor/ Agent</li>
                                                <li>Complete Documentation</li>
                                              </ul>
                                        </div>
                                        <div class="table-footer">
                                            <a href="contactus.php">Enquire now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
