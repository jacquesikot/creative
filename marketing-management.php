                ...
                <div class="col-lg-8 col-md-12 col-sm-12 content-side">
                    <div class="service-details-content">
                        <div class="content-style-one">
                            <figure class="image-box"><img src="assets/images/service/marketing_management_dubai.jpg" alt=""></figure>
                    ...
                    <div class="service-sidebar">
                        <div class="sidebar-categories">
                            <ul class="categories-list clearfix">
                                <li><a href="marketing-management.php" class="active">Marketing Management</a></li>
                        ...
                        <div class="download-option">
                            ...
                            <ul class="download-file clearfix">
                                <li><a download href="testPdf.pdf"><i class="fas fa-file"></i>Company Profile</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
