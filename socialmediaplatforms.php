...
<title>Creative - Social Media Platforms</title>
                            ...
                            <div class="image-box">
                                <div class="row clearfix">
                                    <div class="col-lg-6 col-md-6 col-sm-12 image-column">
                                        <figure class="image"><img src="assets/images/service/service-12.jpg" alt=""></figure>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12 image-column">
                                        <figure class="image"><img src="assets/images/service/service-13.jpg" alt=""></figure>
                                    </div>
                                </div>
                            </div>
                            <div class="text">
                                ...
                                <div class="content-box">
                                    <div class="inner-box">
                                        <div class="single-item">
                                            ...
                                            <p>Veniam quis nostrud exercitason ullamco ipsum laboris sed ut perspiciatis <br />unde sed ipsum nostrud omnis iste natus.</p>
                                        </div>
                                        <div class="single-item">
                                            <div class="icon-box">
                                                <span class="bg-box"></span>
                    ...
                    <div class="service-sidebar">
                        <div class="sidebar-categories">
                            <ul class="categories-list clearfix">
                                ...
                                <li><a href="socialmediaplatforms.php" class="active">Social Media Platforms</a></li>
                        ...
                        <div class="sidebar-info">
                            ...
                            <div class="sidebar-content">
                                ...
                                <ul class="info-list clearfix">
                                    ...
                                    <li><i class="fas fa-headphones"></i><a href="tel:101005200369">+1 0100 5200 369</a></li>
                                </ul>
                                <ul class="social-links clearfix">
                                <li><a rel="noopener noreferrer" href="https://www.facebook.com" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
                                <li><a rel="noopener noreferrer" href="https://www.twitter.com" target="_blank"><i class="fab fa-twitter"></i></a></li>
                                <li><a rel="noopener noreferrer" href="https://www.linkdin.com" target="_blank"><i class="fab fa-linkedin-in"></i></a></li>
                                <li><a rel="noopener noreferrer" href="https://www.linkdin.com" target="_blank"><i class="fab fa-instagram"></i></a></li>
                                </ul>
                            </div>
                        </div>
