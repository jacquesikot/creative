...
<title>Creative Link Services - Stationary Supplies</title>
                ...
                <div class="col-lg-8 col-md-12 col-sm-12 content-side">
                    <div class="service-details-content">
                        <div class="content-style-one">
                            <figure class="image-box"><img src="assets/images/service/stationary_supplies_dubai.jpg" alt=""></figure>
                    ...
                    <div class="service-sidebar">
                        <div class="sidebar-categories">
                            <ul class="categories-list clearfix">
                                ...
                                <li><a href="stationary-supplies.php" class="active">Stationary Supplies</a></li>
