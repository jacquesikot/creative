    ...
    <section class="page-title centred" style="background-image: url(assets/images/background/page-title-4.jpg);">
        <div class="auto-container">
            <div class="content-box clearfix">
                <h1>Website & Mobile Applications</h1>
                <ul class="bread-crumb clearfix">
                    <li><a href="index.php">Home</a></li>
                    <li><a href="company-branding.php">Company Branding</a></li>
                    <li>Website & Mobile Applications</li>
                </ul>
            </div>
        </div>
    </section>
                ...
                <div class="col-lg-8 col-md-12 col-sm-12 content-side">
                    <div class="service-details-content">
                        <div class="content-style-one">
                            <figure class="image-box"><img src="assets/images/service/web_development_in_dubai.jpg" alt=""></figure>
                    ...
                    <div class="service-sidebar">
                        <div class="sidebar-categories">
                            <ul class="categories-list clearfix">
                                ...
                                <li><a href="website-mobile-applications.php" class="active">Website & Mobile Applications</a></li>
                            </ul>
                        </div>
